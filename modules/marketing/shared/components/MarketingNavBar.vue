...
<nav
  id="marketing-header"
  class="fixed left-0 top-0 z-50 w-full rounded-b-xl backdrop-blur-xl border-b
         transition-all duration-300 ease-in-out"
  :class="[isTop ? 'shadow-none bg-transparent' : 'bg-white/60 dark:bg-black/40']"
  style="box-shadow:
...
>
    ...
    <div :class="[isDoc ? 'w-full px-4 border-b' : 'w-full']" class="relative z-50">
      <div
        class="flex items-center justify-between w-full transition-all duration-200"
